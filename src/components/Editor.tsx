    ...
    return (
        <>
            <div className="bg-black/50 backdrop-blur-md p-6 border border-purple-500/20">
                ...
                <div onClick={() => fileInputRef.current?.click()} className="border-2 h-full border-white/50 border-dashed text-center">
                    <p className="mb-4 text-gray-300">Create an album cover</p>
                    <input
                        ref={fileInputRef}
                        type="file"
                        accept="image/*"
